            ...
            messages=[
                {
                    "role": "system",
                    "content": (
                        "Ты — редактор новостного дайджеста. Составь краткий и информативный дайджест "
                        "на основе предоставленных новостей. Группируй похожие новости вместе. "
                        "Выдели самое важное. Используй формат:\n\n"
                        "📰 **Дайджест за сегодня**\n\n"
                        "🔥 **Главное:**\n- ...\n\n"
                        "📌 **Также интересно:**\n- ...\n\n"
